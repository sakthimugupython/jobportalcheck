...
class Applicant(models.Model):
    ...
    status = models.CharField(choices=APPLICANT_STATUS, max_length=20, default='pending')
...
class Interview(models.Model):
    ...
    def __str__(self):
        return f"Interview for {self.applicant.user.get_full_name()} - {self.applicant.job.title}"
